...
export default async function ResultadosCamposPage({
  ...
  // `URLSearchParams` a partir del objeto `searchParams` ya resuelto: es lo
  // que satisface `OrigenParametros` (mismo parseo que usa el fetch por
  // bbox en el cliente, vía `useSearchParams()`).
  ...
  return (
    <main className="mx-auto flex max-w-7xl flex-col gap-8 px-6 py-10 lg:flex-row lg:items-start">
      ...
      <div className="min-w-0 flex-1">
        ...
        <ResultadosCampos camposIniciales={camposIniciales} basePathFicha="/campos" />
      </div>
    </main>
  );
}
