...
export const metadata: Metadata = {
  title: 'Inmobiliarias Rurales (draft)',
...
export default async function InmobiliariasPage({
  ...
  return (
    <>
      <HeroSeccion
        src="/imagenes/hero-inmobiliarias.jpg"
        alt=""
        titulo="Inmobiliarias Rurales"
        subtitulo="Directorio de inmobiliarias socias de CAIR en toda Argentina."
      />
      <main className="mx-auto flex max-w-7xl flex-col gap-8 px-6 py-10 lg:flex-row lg:items-start">
        <aside className="w-full shrink-0 lg:w-72">
          ...
          <form action="/v2/inmobiliarias" className="flex flex-col gap-6 lg:mt-6">
