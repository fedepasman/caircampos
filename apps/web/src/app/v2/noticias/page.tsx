...
export const metadata: Metadata = {
  title: 'Noticias del sector rural (draft)',
  description:
  ...
  return (
    <>
      <HeroSeccion
        ...
        alt=""
        titulo="Noticias del sector rural"
        subtitulo="Análisis, tendencias y novedades del mercado inmobiliario rural argentino."
      />
      <main className="mx-auto max-w-5xl px-6 py-10">
        {!destacada && <p className="text-neutral-800">Todavía no hay noticias publicadas.</p>}

        {destacada && (
          <Link href={`/v2/noticias/${destacada.slug}`} className="group block">
