...
export function BuscadorMapa({ campos }: { campos: CampoParaBusqueda[] }) {
  ...
  return (
    <div className="relative mt-8 h-[420px] overflow-hidden rounded-lg border border-neutral-600 bg-neutral-50 shadow-lg md:h-[560px]">
      ...
      <div className="absolute top-2 left-2 z-10 w-48 rounded-md border border-neutral-600 bg-neutral-50 p-3 shadow-md sm:top-4 sm:left-4 sm:w-56 sm:p-4">
        <p className="font-display text-sm font-semibold text-neutral-950">Filtrar área</p>
        ...
        <input
          ...
          className="mt-3 w-full rounded-sm border border-neutral-700 bg-neutral-50 px-2 py-1.5 text-sm text-neutral-950 placeholder:text-neutral-700"
        />
